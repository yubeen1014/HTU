...
.enrolment_box a:hover{color: #fff;}
...
<div class="enrolment_box">
	...
	<div style="display:flex; justify-content:space-between;">
		...
		<div style="">
			<a href="/student/enrolment/app" class="enapp-link" style="border:2px solid #ccc; transition:0.3s; padding:5px 10px; border-radius:5px;">수강신청바로가기</a>
		</div>
	</div>
