...
<!--       </button> -->
    ...
    //노드트리
			...
			if (!['http://localhost/employee/proadmin/proinfo', 'http://localhost/employee/stuadmin/stuinfo', 
			'http://localhost/employee/proadmin/proinfo#none', 'http://localhost/employee/stuadmin/stuinfo#none',
			'http://192.168.145.38/employee/proadmin/proinfo','http://192.168.145.38/employee/stuadmin/stuinfo',
			'http://192.168.145.38/employee/proadmin/proinfo#none','http://192.168.145.38/employee/stuadmin/stuinfo#none'].includes(url)) {
				$(function () {
          // 노드정보를 저장하기 위한 변수
          var data = [];
